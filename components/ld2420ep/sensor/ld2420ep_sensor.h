...
namespace esphome
{
  namespace ld2420ep
  {
    ...
    class LD2420EPSensor : public LD2420EPListener, public Component, sensor::Sensor
    {
    public:
    ...
    protected:
      ...
      std::vector<sensor::Sensor *> energy_sensors_ = std::vector<sensor::Sensor *>(LD2420EP_TOTAL_GATES);
    };
